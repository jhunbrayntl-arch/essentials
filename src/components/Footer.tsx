      ...
      <div className="container mx-auto px-4 md:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold tracking-tighter">ESSENTIALS</h3>
            <p className="text-neutral-400 text-sm leading-relaxed">
              Minimalist clothing for the modern individual. Quality essentials that transcend seasons.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-neutral-400 text-sm">
              ...
              <li><Link href="/products?category=outerwear" className="hover:text-white transition-colors">Outerwear</Link></li>
          ...
          <div>
            ...
            <p className="text-neutral-400 text-sm mb-4">Subscribe for exclusive offers and early access.</p>
            <form className="space-y-3">
              <input
                type="email"
                placeholder="Enter your email"
                className="w-full px-4 py-3 bg-neutral-800 border border-neutral-700 text-white text-sm focus:outline-none focus:border-neutral-500"
              />
              <button type="submit" className="w-full btn-primary bg-white text-black hover:bg-neutral-200">
                Subscribe
              </button>
            </form>
          </div>
